...
def _load_adapters():
    ...
    if _ADAPTER_CLASSES:
        return
    from backend.modules.data_sources.fabric import FabricDataSource
    from backend.modules.data_sources.sql import SqlDataSource
    from backend.modules.data_sources.synapse import SynapseDataSource
    from backend.modules.data_sources.odbc import OdbcDataSource
    from backend.modules.data_sources.azure_search import AzureSearchDataSource
