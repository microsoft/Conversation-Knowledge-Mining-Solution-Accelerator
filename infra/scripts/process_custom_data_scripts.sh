...
curl --output "04_cu_process_custom_data.py.py" ${baseUrl}"infra/scripts/index_scripts/04_cu_process_custom_data.py.py"
...
sed -i "s/kv_to-be-replaced/${keyvaultName}/g" "04_cu_process_custom_data.py.py"
sed -i "s/mici_to-be-replaced/${managedIdentityClientId}/g" "04_cu_process_custom_data.py.py"

pip install -r requirements.txt

python 04_cu_process_custom_data.py.py