...
bulk_import_json_to_table( './infra/data/sample_processed_data.json', 'processed_data')
bulk_import_json_to_table('./infra/data/sample_processed_data_key_phrases.json', 'processed_data_key_phrases')
