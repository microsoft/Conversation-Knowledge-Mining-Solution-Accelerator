...
DEFAULT_MODEL_CAPACITY="gpt-5.2:150,gpt-4o-mini:150,gpt-4:150,text-embedding-3-small:80"
...
DEFAULT_REGIONS="australiaeast,swedencentral,southeastasia,westus3"
