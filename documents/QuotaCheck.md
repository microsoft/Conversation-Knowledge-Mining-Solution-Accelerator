...
```
gpt-4o:50, gpt-4o-mini:50, gpt-4:50, text-embedding-3-small:80
```
### 📌 Default Regions:
```
...
✔️ Check specific model(s) in default regions:
  ```
  ./quota_check_params.sh --models gpt-4o:50,text-embedding-3-small:80
  ```
...
✔️ All parameters combined:
  ```
 ./quota_check_params.sh --models gpt-4:50,text-embedding-3-small:80 --regions eastus,westus --verbose
  ```
