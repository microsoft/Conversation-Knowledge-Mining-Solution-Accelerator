...
from common.logging.llm_token_telemetry import TokenUsageEmitter

_log = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Accelerator identity -- change this value per accelerator repo.
# ---------------------------------------------------------------------------
_APP_NAME = os.getenv("TOKEN_TELEMETRY_APP_NAME", "CKM")
...
# ---------------------------------------------------------------------------
# Singleton emitter -- import this from anywhere in the application.
# ---------------------------------------------------------------------------
token_emitter = TokenUsageEmitter(
    static_dimensions={"app": _APP_NAME},
